...
// Handle student booking room
app.post('/api/student/book-room', (req, res) => {
  const { roomNumber, bookingDate, bookingTime } = req.body; 



  // ส่งการตอบกลับไปยังผู้ใช้งาน
  res.send('Student booking room successful'); 
});
...
app.put('/api/staff/disable-room/:roomId', (req, res) => {
  // Implement disabling room logic here
});
